...
# _, id_index = torch.sort(torch.Tensor(id_scores_test))
# _, ood1_index = torch.sort(torch.Tensor(ood1_scores))
# _, ood2_index = torch.sort(torch.Tensor(ood2_scores))
# _, ood3_index = torch.sort(torch.Tensor(ood3_scores))
# _, ood4_index = torch.sort(torch.Tensor(ood4_scores))
# _, ood5_index = torch.sort(torch.Tensor(ood5_scores))
# _, ood6_index = torch.sort(torch.Tensor(ood6_scores))

# torch.save(id_index, "../data/id_index_test")
# torch.save(ood1_index, "../data/ood1_index")
# torch.save(ood2_index, "../data/ood2_index")
# torch.save(ood3_index, "../data/ood3_index")
# torch.save(ood4_index, "../data/ood4_index")
# torch.save(ood5_index, "../data/ood5_index")
# torch.save(ood6_index, "../data/ood6_index")
...
# 3
# id_feats_test = id_feats_test[id_index[2000:3000]]
# ood1_feats = ood1_feats[ood1_index[-3000:-2000]]
# ood2_feats = ood2_feats[ood2_index[-3000:-2000]]
# ood3_feats = ood3_feats[ood3_index[-3000:-2000]]
# ood4_feats = ood4_feats[ood4_index[-3000:-2000]]
# ood5_feats = ood5_feats[ood5_index[-3000:-2000]]
# ood6_feats = ood6_feats[ood6_index[-3000:-2000]]

# 1
# id_feats_test = id_feats_test[id_index[1000:2000]]
# ood1_feats = ood1_feats[ood1_index[-2000:-1000]]
# ood2_feats = ood2_feats[ood2_index[-2000:-1000]]
# ood3_feats = ood3_feats[ood3_index[-2000:-1000]]
# ood4_feats = ood4_feats[ood4_index[-2000:-1000]]
# ood5_feats = ood5_feats[ood5_index[-2000:-1000]]
# ood6_feats = ood6_feats[ood6_index[-2000:-1000]]
...
# 2
# id_feats_test = id_feats_test[id_index[:1000]]
# ood1_feats = ood1_feats[ood1_index[-1000:]]
# ood2_feats = ood2_feats[ood2_index[-1000:]]
# ood3_feats = ood3_feats[ood3_index[-1000:]]
# ood4_feats = ood4_feats[ood4_index[-1000:]]
# ood5_feats = ood5_feats[ood5_index[-1000:]]
# ood6_feats = ood6_feats[ood6_index[-1000:]]

# id_feats_test = id_feats_test[:2000]
# ood1_feats = ood1_feats[-2000:]
# ood2_feats = ood2_feats[-2000:]
# ood3_feats = ood3_feats[-2000:]
# ood4_feats = ood4_feats[-2000:]
# ood5_feats = ood5_feats[-2000:]
# ood6_feats = ood6_feats[-2000:]

# if args.num_dataset == 1:
#     ood_feats = ood1_feats[ood1_index[:1000]]
# elif args.num_dataset == 2:
#     ood_feats = ood2_feats[ood2_index[:1000]]
# elif args.num_dataset == 3:
#     ood_feats = ood3_feats[ood3_index[:1000]]
# elif args.num_dataset == 4:
#     ood_feats = ood4_feats[ood4_index[:1000]]
# elif args.num_dataset == 5:
#     ood_feats = ood5_feats[ood5_index[:1000]]
# elif args.num_dataset == 6:
#     ood_feats = ood6_feats[ood6_index[:1000]]

# colors = ["firebrick", "limegreen"]
# tsne_data = torch.cat([id_feats_test, ood_feats])
# colors = ["crimson", "y", "limegreen", "lightseagreen", "royalblue", "darkviolet", "goldenrod"]
colors = plt.get_cmap('Set1').colors
labels = ["CIFAR100", "Textures", "Places365", "LSUN-Crop", "LSUN-Resize", "iSUN", "SVHN"]
...
# decomp = NMF(n_components=2, max_iter=20000)
# decomp = FastICA(n_components=2, max_iter=20000)
# decomp.fit(tsne_data.cpu())
# tsne_data_trans = torch.Tensor(decomp.transform(tsne_data.cpu()))
tsne_data_trans = decomp.fit_transform(tsne_data.cpu())

plt.figure(figsize=(12, 8))
for i in range(7):
    plt.scatter(tsne_data_trans[i *500:(i + 1) * 500, 0], tsne_data_trans[i * 500:(i + 1) * 500, 1], s=5, color=colors[i], marker='o', label=labels[i])
...
if args.method == "pca":
    # plt.savefig("./decomp/final_pca_scatter_1000.png")
    # plt.savefig("./decomp/final_pca_scatter_1000.svg")
    if args.order == 1:
        plt.savefig("./decomp/final_pca_scatter_500_1.svg")
    elif args.order == 2:
        plt.savefig("./decomp/final_pca_scatter_500_2.svg")
    # plt.savefig("./decomp/final_pca_scatter_1000_2.png")
    # plt.savefig("./decomp/final_pca_scatter_1000_3.png")
elif args.method == "nmf":
    # plt.savefig("./decomp/final_nmf_scatter_1000.png")
    # plt.savefig("./decomp/final_nmf_scatter_1000.svg")
    if args.order == 1:
        plt.savefig("./decomp/final_nmf_scatter_500_1.svg")
    elif args.order == 2:
        plt.savefig("./decomp/final_nmf_scatter_500_2.svg")
    # plt.savefig("./decomp/final_nmf_scatter_1000_2.png")
elif args.method == "ica":
    # plt.savefig("./decomp/final_ica_scatter_1000.png")
    # plt.savefig("./decomp/final_ica_scatter_1000.svg")
    if args.order == 1:
        plt.savefig("./decomp/final_ica_scatter_500_1.svg")
    elif args.order == 2:
        plt.savefig("./decomp/final_ica_scatter_500_2.svg")
    # plt.savefig("./decomp/final_ica_scatter_1000_2.png")
    # plt.savefig("./decomp/final_ica_scatter_1000_3.png")
