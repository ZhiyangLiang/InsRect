...
def my_plt_bar(item_num, start, end, pictype, datatype, percent):
    if datatype == "id":
        global id_feats_invariant
        id_feats = torch.clone(id_feats_invariant)
        if pictype == "origin":
            plt.bar(range(342 - start - end), id_feats[item_num][start:342 - end].cpu(), color=['royalblue'], width=args.width)
            plt.ylim((0.0, 7.5))
            plt.xticks([])
            plt.yticks([])
            ...
            plt.bar(range(342 - start - end), id_feats[item_num][start:342 - end].cpu(), color=['lightsteelblue'], width=args.width)
            plt.ylim((0.0, 7.5))
            plt.xticks([])
            plt.yticks([])
            # plt.savefig("./" + datatype + "_" + pictype + "_" + str(item_num) + "_" + str(percent) + "_" + str(args.width) + "_lightsteelblue.png")
            plt.savefig("./" + datatype + "_" + pictype + "_" + str(item_num) + "_" + str(percent) + "_" + str(args.width) + "_lightsteelblue.svg")
            plt.clf()
        elif pictype == "react1":
            plt.bar(range(342 - start - end), id_feats[item_num][start:342 - end].cpu(), color=['lightsteelblue'], width=args.width)
            plt.ylim((0.0, 7.5))
        ...
        if pictype == "origin":
            plt.bar(range(342 - start - end), ood_feats[item_num][start:342 - end].cpu(), color=['dimgrey'], width=args.width)
            plt.ylim((0.0, 7.5))
            plt.xticks([])
            plt.yticks([])
            ...
            plt.bar(range(342 - start - end), ood_feats[item_num][start:342 - end].cpu(), color=['lightgrey'], width=args.width)
            plt.ylim((0.0, 7.5))
            plt.xticks([])
            plt.yticks([])
...
if args.idtype == "yes":
    my_plt_bar(7, args.start, args.end, "origin", "id", 90)
    my_plt_bar(7, args.start, args.end, "ash", "id", 90)
    my_plt_bar(7, args.start, args.end, "react1", "id", 90)
    my_plt_bar(7, args.start, args.end, "react2", "id", 90)
    my_plt_bar(7, args.start, args.end, "origin", "id", 80)
    my_plt_bar(7, args.start, args.end, "ash", "id", 80)
    my_plt_bar(7, args.start, args.end, "react1", "id", 80)
    my_plt_bar(7, args.start, args.end, "react2", "id", 80)
    my_plt_bar(7, args.start, args.end, "origin", "id", 70)
    my_plt_bar(7, args.start, args.end, "ash", "id", 70)
    my_plt_bar(7, args.start, args.end, "react1", "id", 70)
    my_plt_bar(7, args.start, args.end, "react2", "id", 70)
    my_plt_bar(7, args.start, args.end, "origin", "id", 60)
    my_plt_bar(7, args.start, args.end, "ash", "id", 60)
    my_plt_bar(7, args.start, args.end, "react1", "id", 60)
    my_plt_bar(7, args.start, args.end, "react2", "id", 60)

    # my_plt_bar(7, args.start, args.end, "origin", "id", 95)
    # my_plt_bar(7, args.start, args.end, "ash", "id", 95)
    # my_plt_bar(7, args.start, args.end, "react1", "id", 95)
    # my_plt_bar(7, args.start, args.end, "react2", "id", 95)
    # my_plt_bar(7, args.start, args.end, "origin", "id", 85)
    # my_plt_bar(7, args.start, args.end, "ash", "id", 85)
    # my_plt_bar(7, args.start, args.end, "react1", "id", 85)
    # my_plt_bar(7, args.start, args.end, "react2", "id", 85)
    # my_plt_bar(7, args.start, args.end, "origin", "id", 75)
    # my_plt_bar(7, args.start, args.end, "ash", "id", 75)
    # my_plt_bar(7, args.start, args.end, "react1", "id", 75)
    # my_plt_bar(7, args.start, args.end, "react2", "id", 75)
    # my_plt_bar(7, args.start, args.end, "origin", "id", 65)
    # my_plt_bar(7, args.start, args.end, "ash", "id", 65)
    # my_plt_bar(7, args.start, args.end, "react1", "id", 65)
    # my_plt_bar(7, args.start, args.end, "react2", "id", 65)
if args.oodtype == "yes":
    my_plt_bar(23, args.start, args.end, "origin", "ood", 90)
    my_plt_bar(23, args.start, args.end, "ash", "ood", 90)
    my_plt_bar(23, args.start, args.end, "react1", "ood", 90)
    my_plt_bar(23, args.start, args.end, "react2", "ood", 90)
    my_plt_bar(23, args.start, args.end, "origin", "ood", 80)
    my_plt_bar(23, args.start, args.end, "ash", "ood", 80)
    my_plt_bar(23, args.start, args.end, "react1", "ood", 80)
    my_plt_bar(23, args.start, args.end, "react2", "ood", 80)
    my_plt_bar(23, args.start, args.end, "origin", "ood", 70)
    my_plt_bar(23, args.start, args.end, "ash", "ood", 70)
    my_plt_bar(23, args.start, args.end, "react1", "ood", 70)
    my_plt_bar(23, args.start, args.end, "react2", "ood", 70)
    my_plt_bar(23, args.start, args.end, "origin", "ood", 60)
    my_plt_bar(23, args.start, args.end, "ash", "ood", 60)
    my_plt_bar(23, args.start, args.end, "react1", "ood", 60)
    my_plt_bar(23, args.start, args.end, "react2", "ood", 60)

    # my_plt_bar(23, args.start, args.end, "origin", "ood", 95)
    # my_plt_bar(23, args.start, args.end, "ash", "ood", 95)
    # my_plt_bar(23, args.start, args.end, "react1", "ood", 95)
    # my_plt_bar(23, args.start, args.end, "react2", "ood", 95)
    # my_plt_bar(23, args.start, args.end, "origin", "ood", 85)
    # my_plt_bar(23, args.start, args.end, "ash", "ood", 85)
    # my_plt_bar(23, args.start, args.end, "react1", "ood", 85)
    # my_plt_bar(23, args.start, args.end, "react2", "ood", 85)
    # my_plt_bar(23, args.start, args.end, "origin", "ood", 75)
    # my_plt_bar(23, args.start, args.end, "ash", "ood", 75)
    # my_plt_bar(23, args.start, args.end, "react1", "ood", 75)
    # my_plt_bar(23, args.start, args.end, "react2", "ood", 75)
    # my_plt_bar(23, args.start, args.end, "origin", "ood", 65)
    # my_plt_bar(23, args.start, args.end, "ash", "ood", 65)
    # my_plt_bar(23, args.start, args.end, "react1", "ood", 65)
    # my_plt_bar(23, args.start, args.end, "react2", "ood", 65)
