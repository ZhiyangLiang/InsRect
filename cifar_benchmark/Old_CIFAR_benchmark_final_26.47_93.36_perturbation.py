...
parser.add_argument("--setting", type=str, choices=["common", "hard"])
...
if args.auxiliary_trans == "ood":
    ...
    # ood_data = dset.ImageFolder(root="../data/tiny-imagenet-200/CIFAR10_train", transform=ood_transform)
    ...
    # ood_data = dset.ImageFolder(root="../data/tiny-imagenet-200/CIFAR10_train", transform=eval_transform)
...
if args.setting == "common":
    ...
    ood1_data = dset.ImageFolder(root="../data/LSUN_pil", transform=eval_transform)
    ood2_data = dset.ImageFolder(root="../data/Imagenet_pil", transform=eval_transform)
    ood3_data = dset.ImageFolder(root="../data/Imagenet_resize", transform=eval_transform)
    ood4_data = dset.ImageFolder(root="../data/Oxford_Pets", transform=eval_transform)
    # ood5_data = dset.ImageFolder(root="../data/Stanford_Dogs",transform=eval_transform)
    # ood5_data = dset.CIFAR10("../data/cifar10", train=False, transform=eval_transform, download=False)
    ood5_data = dset.CIFAR100("../data/cifar100", train=False, transform=eval_transform, download=False)
    ood6_data = dset.ImageFolder(root="../data/102flowers",transform=eval_transform)
...
def extract_feats(feats, loader, opt=0):
    ...
    with torch.no_grad():
        for batch_idx, (data, target) in enumerate(loader):
            data, target = data.cuda(), target.cuda()
            if opt == 1:
                data = data + torch.empty_like(data).uniform_(-args.perturbation, args.perturbation)
...
extract_feats(ood_feats_2, ood_loader, 1)
extract_feats(ood_feats_3, ood_loader, 1)
# extract_feats(ood_feats_4, ood_loader, 1)
...
# ood_feats = torch.load("../data/vos_cifar100_densenet_dice_24.pkl")
# ood_feats = nmf_relu(ood_feats)

# ood_feats_2 = torch.cat(ood_feats_2, dim=0)
# ood_feats_3 = torch.cat(ood_feats_3, dim=0)
# ood_feats_4 = torch.cat(ood_feats_4, dim=0)
# ood_feats = torch.cat([ood_feats, ood_feats_2], dim=0)
ood_feats = torch.cat([ood_feats, ood_feats_2, ood_feats_3], dim=0)
# ood_feats = torch.cat([ood_feats, ood_feats_2, ood_feats_3, ood_feats_4], dim=0)
ood_feats = nmf_relu(ood_feats)
...
# def eval_datasets(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50, r51, r52, r53, r54, r55, r56, r57, r58, r59, r60, r61, r62, r63, r64, r65, r66, r67, r68, r69, r70, r71, r72, r73, r74, r75, r76, r77, r78, r79, r80, r81, r82, r83, r84, r85, r86, r87, r88, r89, r90, r91, r92, r93, r94, r95, r96, r97, r98, r99, r100, r101, r102, r103, r104, r105, r106, r107, r108, r109, r110, r111, r112, r113, r114, r115, r116, r117, r118, r119, r120, r121, r122, r123, r124, r125, r126, r127, r128, r129, r130, r131, r132, r133, r134, r135, r136, r137, r138, r139, r140, r141, r142, r143, r144, r145, r146, r147, r148, r149, r150, r151, r152, r153, r154, r155, r156, r157, r158, r159, r160, r161, r162, r163, r164, r165, r166, r167, r168, r169, r170, r171, r172, r173, r174, r175, r176, r177, r178, r179, r180, r181, r182, r183, r184, r185, r186, r187, r188, r189, r190, r191, r192, r193, r194, r195, r196, r197, r198, r199, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21, c22, c23, c24, c25, c26, c27, c28, c29, c30, c31, c32, c33, c34, c35, c36, c37, c38, c39, c40, c41, c42, c43, c44, c45, c46, c47, c48, c49, c50, c51, c52, c53, c54, c55, c56, c57, c58, c59, c60, c61, c62, c63, c64, c65, c66, c67, c68, c69, c70, c71, c72, c73, c74, c75, c76, c77, c78, c79, c80, c81, c82, c83, c84, c85, c86, c87, c88, c89, c90, c91, c92, c93, c94, c95, c96, c97, c98, c99, c100, c101, c102, c103, c104, c105, c106, c107, c108, c109, c110, c111, c112, c113, c114, c115, c116, c117, c118, c119, c120, c121, c122, c123, c124, c125, c126, c127, c128, c129, c130, c131, c132, c133, c134, c135, c136, c137, c138, c139, c140, c141, c142, c143, c144, c145, c146, c147, c148, c149, c150, c151, c152, c153, c154, c155, c156, c157, c158, c159, c160, c161, c162, c163, c164, c165, c166, c167, c168, c169, c170, c171, c172, c173, c174, c175, c176, c177, c178, c179, c180, c181, c182, c183, c184, c185, c186, c187, c188, c189, c190, c191, c192, c193, c194, c195, c196, c197, c198, c199):
    ...
    if args.score == "msp":
        m_id_score =  - F.softmax(m_id_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
        m_ood_score =  - F.softmax(m_ood_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
    ...
    if fpr < final_fpr:
        ...
        # torch.save(m_id_feats, "../data/after_clamping_cifar10_densenet_dice_id_feats.pkl")
        # torch.save(m_ood_feats, "../data/after_clamping_cifar10_densenet_dice_ood_feats.pkl")
        # torch.save(m_id_feats_test, "../data/after_clamping_cifar10_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/after_clamping_cifar10_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/after_clamping_cifar10_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/after_clamping_cifar10_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/after_clamping_cifar10_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/after_clamping_cifar10_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/after_clamping_cifar10_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats, "../data/after_clamping_cifar100_densenet_dice_id_feats.pkl")
        # torch.save(m_ood_feats, "../data/after_clamping_cifar100_densenet_dice_ood_feats.pkl")
        # torch.save(m_id_feats_test, "../data/after_clamping_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/after_clamping_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/after_clamping_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/after_clamping_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/after_clamping_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/after_clamping_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/after_clamping_cifar100_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_id_feats.pkl")
        # torch.save(m_ood_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood_feats.pkl")
        # torch.save(m_id_feats_test, "../data/nmf_after_clamping_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/nmf_after_clamping_cifar100_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats, "../data/pca_after_clamping_cifar100_densenet_dice_id_feats.pkl")
        # torch.save(m_ood_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood_feats.pkl")
        # torch.save(m_id_feats_test, "../data/pca_after_clamping_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/pca_after_clamping_cifar100_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats, "../data/ica_after_clamping_cifar100_densenet_dice_id_feats.pkl")
        # torch.save(m_ood_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood_feats.pkl")
        # torch.save(m_id_feats_test, "../data/ica_after_clamping_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/ica_after_clamping_cifar100_densenet_dice_ood6_feats.pkl")
        ...
        # torch.save(m_id_feats_test, "../data/after_clamping_sca_cifar10_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/after_clamping_sca_cifar10_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/after_clamping_sca_cifar10_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/after_clamping_sca_cifar10_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/after_clamping_sca_cifar10_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/after_clamping_sca_cifar10_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/after_clamping_sca_cifar10_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats_test, "../data/after_clamping_sca_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/after_clamping_sca_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/after_clamping_sca_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/after_clamping_sca_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/after_clamping_sca_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/after_clamping_sca_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/after_clamping_sca_cifar100_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats_test, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/nmf_after_clamping_sca_cifar100_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats_test, "../data/pca_after_clamping_sca_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/pca_after_clamping_sca_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/pca_after_clamping_sca_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/pca_after_clamping_sca_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/pca_after_clamping_sca_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/pca_after_clamping_sca_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/pca_after_clamping_sca_cifar100_densenet_dice_ood6_feats.pkl")

        # torch.save(m_id_feats_test, "../data/ica_after_clamping_sca_cifar100_densenet_dice_id_feats_test.pkl")
        # torch.save(m_ood1_feats, "../data/ica_after_clamping_sca_cifar100_densenet_dice_ood1_feats.pkl")
        # torch.save(m_ood2_feats, "../data/ica_after_clamping_sca_cifar100_densenet_dice_ood2_feats.pkl")
        # torch.save(m_ood3_feats, "../data/ica_after_clamping_sca_cifar100_densenet_dice_ood3_feats.pkl")
        # torch.save(m_ood4_feats, "../data/ica_after_clamping_sca_cifar100_densenet_dice_ood4_feats.pkl")
        # torch.save(m_ood5_feats, "../data/ica_after_clamping_sca_cifar100_densenet_dice_ood5_feats.pkl")
        # torch.save(m_ood6_feats, "../data/ica_after_clamping_sca_cifar100_densenet_dice_ood6_feats.pkl")
        ...
        if args.score == "msp":
            m_id_score_test =  - F.softmax(m_id_logits_test, dim=1).max(dim=1)[0].cpu().detach().numpy()
            m_ood1_score =  - F.softmax(m_ood1_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
            m_ood2_score =  - F.softmax(m_ood2_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
            m_ood3_score =  - F.softmax(m_ood3_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
            m_ood4_score =  - F.softmax(m_ood4_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
            m_ood5_score =  - F.softmax(m_ood5_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
            m_ood6_score =  - F.softmax(m_ood6_logits, dim=1).max(dim=1)[0].cpu().detach().numpy()
        elif args.score == "energy":
    ...
    if args.setting == "common":
        ...
        print("LSUN_pil_fpr: %.4f; LSUN_pil_auroc: %.4f" % (final_fpr1, final_auroc1))
        print("Imagenet_pil_fpr: %.4f; Imagenet_pil_auroc: %.4f" % (final_fpr2, final_auroc2))
        print("Imagenet_resize_fpr: %.4f; Imagenet_resize_auroc: %.4f" % (final_fpr3, final_auroc3))
        print("Oxford_Pets: %.4f; Oxford_Pets_auroc: %.4f" % (final_fpr4, final_auroc4))
        print("cifar100_fpr: %.4f; cifar100_auroc: %.4f" % (final_fpr5, final_auroc5))
        print("102flowers_fpr: %.4f; 102flowers_auroc: %.4f" % (final_fpr6, final_auroc6))
