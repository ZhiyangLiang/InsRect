...
parser.add_argument("--w_oe", type=str, choices=["yes", "no"])
...
if args.dataset == "cifar10":
    ...
    if args.model == "resnet50":
        ...
        if args.w_oe == "yes":
            model.load_state_dict(torch.load("./oe_tune/cifar100_densenet_dice_oe_tune_epoch_9.pt"))
        else:
...
# torch.save(id_feats_test, "cifar100_densenet_id_feats_test_0")
# torch.save(ood1_feats, "cifar100_densenet_ood1_feats_0")
# torch.save(ood2_feats, "cifar100_densenet_ood2_feats_0")
# torch.save(ood3_feats, "cifar100_densenet_ood3_feats_0")
# torch.save(ood4_feats, "cifar100_densenet_ood4_feats_0")
# torch.save(ood5_feats, "cifar100_densenet_ood5_feats_0")
# torch.save(ood6_feats, "cifar100_densenet_ood6_feats_0")
...
react_lower_bound = args.lower_percentile
react_upper_bound = args.upper_percentile
...
# def eval_datasets(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50, r51, r52, r53, r54, r55, r56, r57, r58, r59, r60, r61, r62, r63, r64, r65, r66, r67, r68, r69, r70, r71, r72, r73, r74, r75, r76, r77, r78, r79, r80, r81, r82, r83, r84, r85, r86, r87, r88, r89, r90, r91, r92, r93, r94, r95, r96, r97, r98, r99, r100, r101, r102, r103, r104, r105, r106, r107, r108, r109, r110, r111, r112, r113, r114, r115, r116, r117, r118, r119, r120, r121, r122, r123, r124, r125, r126, r127, r128, r129, r130, r131, r132, r133, r134, r135, r136, r137, r138, r139, r140, r141, r142, r143, r144, r145, r146, r147, r148, r149, r150, r151, r152, r153, r154, r155, r156, r157, r158, r159, r160, r161, r162, r163, r164, r165, r166, r167, r168, r169, r170, r171, r172, r173, r174, r175, r176, r177, r178, r179, r180, r181, r182, r183, r184, r185, r186, r187, r188, r189, r190, r191, r192, r193, r194, r195, r196, r197, r198, r199, c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21, c22, c23, c24, c25, c26, c27, c28, c29, c30, c31, c32, c33, c34, c35, c36, c37, c38, c39, c40, c41, c42, c43, c44, c45, c46, c47, c48, c49, c50, c51, c52, c53, c54, c55, c56, c57, c58, c59, c60, c61, c62, c63, c64, c65, c66, c67, c68, c69, c70, c71, c72, c73, c74, c75, c76, c77, c78, c79, c80, c81, c82, c83, c84, c85, c86, c87, c88, c89, c90, c91, c92, c93, c94, c95, c96, c97, c98, c99, c100, c101, c102, c103, c104, c105, c106, c107, c108, c109, c110, c111, c112, c113, c114, c115, c116, c117, c118, c119, c120, c121, c122, c123, c124, c125, c126, c127, c128, c129, c130, c131, c132, c133, c134, c135, c136, c137, c138, c139, c140, c141, c142, c143, c144, c145, c146, c147, c148, c149, c150, c151, c152, c153, c154, c155, c156, c157, c158, c159, c160, c161, c162, c163, c164, c165, c166, c167, c168, c169, c170, c171, c172, c173, c174, c175, c176, c177, c178, c179, c180, c181, c182, c183, c184, c185, c186, c187, c188, c189, c190, c191, c192, c193, c194, c195, c196, c197, c198, c199):
    ...
    for (i, j) in zip(range(m_trans.shape[0]), react_list):
        m_trans[i] = react(m_trans[i], np.percentile(m_trans[i], j))

    for (i, j) in zip(range(m_trans.shape[0]), ash_list):
        m_trans[i] = ash_s_thre(m_trans[i], np.percentile(m_trans[i], j))
    ...
    # m_id_feats = torch.Tensor(nmf.transform(m_id_feats.cpu())).mm(m_trans).cuda()
    # m_ood_feats = torch.Tensor(nmf.transform(m_ood_feats.cpu())).mm(m_trans).cuda()
    ...
    if args.score == "msp":
        ...
        m_id_score =  - m_id_logits.max(dim=1)[0].cpu().detach().numpy()
        m_ood_score =  - m_ood_logits.max(dim=1)[0].cpu().detach().numpy()
    ...
    if fpr < final_fpr:
        ...
        # m_id_feats_test = torch.Tensor(nmf.transform(m_id_feats_test.cpu())).mm(m_trans).cuda()
        # m_ood1_feats = torch.Tensor(nmf.transform(m_ood1_feats.cpu())).mm(m_trans).cuda()
        # m_ood2_feats = torch.Tensor(nmf.transform(m_ood2_feats.cpu())).mm(m_trans).cuda()
        # m_ood3_feats = torch.Tensor(nmf.transform(m_ood3_feats.cpu())).mm(m_trans).cuda()
        # m_ood4_feats = torch.Tensor(nmf.transform(m_ood4_feats.cpu())).mm(m_trans).cuda()
        # m_ood5_feats = torch.Tensor(nmf.transform(m_ood5_feats.cpu())).mm(m_trans).cuda()
        # m_ood6_feats = torch.Tensor(nmf.transform(m_ood6_feats.cpu())).mm(m_trans).cuda()

        # if cnt <= 10:
        #     m_cnt = 10
        #     if args.method == "pca":
        #         torch.save(m_id_feats_test, "../data/cifar100_densenet_dice_pca_id_feats_test_%d" % (m_cnt))
        #         torch.save(m_ood1_feats, "../data/cifar100_densenet_dice_pca_ood1_feats_%d" % (m_cnt))
        #         torch.save(m_ood2_feats, "../data/cifar100_densenet_dice_pca_ood2_feats_%d" % (m_cnt))
        #         torch.save(m_ood3_feats, "../data/cifar100_densenet_dice_pca_ood3_feats_%d" % (m_cnt))
        #         torch.save(m_ood4_feats, "../data/cifar100_densenet_dice_pca_ood4_feats_%d" % (m_cnt))
        #         torch.save(m_ood5_feats, "../data/cifar100_densenet_dice_pca_ood5_feats_%d" % (m_cnt))
        #         torch.save(m_ood6_feats, "../data/cifar100_densenet_dice_pca_ood6_feats_%d" % (m_cnt))
        #     elif args.method == "nmf":
        #         torch.save(m_id_feats_test, "../data/cifar100_densenet_dice_nmf_id_feats_test_%d" % (m_cnt))
        #         torch.save(m_ood1_feats, "../data/cifar100_densenet_dice_nmf_ood1_feats_%d" % (m_cnt))
        #         torch.save(m_ood2_feats, "../data/cifar100_densenet_dice_nmf_ood2_feats_%d" % (m_cnt))
        #         torch.save(m_ood3_feats, "../data/cifar100_densenet_dice_nmf_ood3_feats_%d" % (m_cnt))
        #         torch.save(m_ood4_feats, "../data/cifar100_densenet_dice_nmf_ood4_feats_%d" % (m_cnt))
        #         torch.save(m_ood5_feats, "../data/cifar100_densenet_dice_nmf_ood5_feats_%d" % (m_cnt))
        #         torch.save(m_ood6_feats, "../data/cifar100_densenet_dice_nmf_ood6_feats_%d" % (m_cnt))
        #     elif args.method == "ica":
        #         torch.save(m_id_feats_test, "../data/cifar100_densenet_dice_ica_id_feats_test_%d" % (m_cnt))
        #         torch.save(m_ood1_feats, "../data/cifar100_densenet_dice_ica_ood1_feats_%d" % (m_cnt))
        #         torch.save(m_ood2_feats, "../data/cifar100_densenet_dice_ica_ood2_feats_%d" % (m_cnt))
        #         torch.save(m_ood3_feats, "../data/cifar100_densenet_dice_ica_ood3_feats_%d" % (m_cnt))
        #         torch.save(m_ood4_feats, "../data/cifar100_densenet_dice_ica_ood4_feats_%d" % (m_cnt))
        #         torch.save(m_ood5_feats, "../data/cifar100_densenet_dice_ica_ood5_feats_%d" % (m_cnt))
        #         torch.save(m_ood6_feats, "../data/cifar100_densenet_dice_ica_ood6_feats_%d" % (m_cnt))
        ...
        if args.score == "msp":
            ...
            m_id_score_test =  - m_id_logits_test.max(dim=1)[0].cpu().detach().numpy()
            m_ood1_score =  - m_ood1_logits.max(dim=1)[0].cpu().detach().numpy()
            m_ood2_score =  - m_ood2_logits.max(dim=1)[0].cpu().detach().numpy()
            m_ood3_score =  - m_ood3_logits.max(dim=1)[0].cpu().detach().numpy()
            m_ood4_score =  - m_ood4_logits.max(dim=1)[0].cpu().detach().numpy()
            m_ood5_score =  - m_ood5_logits.max(dim=1)[0].cpu().detach().numpy()
            m_ood6_score =  - m_ood6_logits.max(dim=1)[0].cpu().detach().numpy()
        elif args.score == "energy":
