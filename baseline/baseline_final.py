...
parser.add_argument("--model", type=str, choices=["resnet50", "densenet_dice", "wideresnet", "wrn", "mobilenet", "densenet161", "wide_resnet50_2", "new_resnet50", "mobilenet_v2"])
parser.add_argument('--ash_p', default=65, type=float, help='ash p')
...
def get_react_scores(features_list, model):
    ...
    with torch.no_grad():
        ...
        # clip = 0.9
        clip = 0.8
        # clip = np.percentile(embed_tensor.cpu(), 90)
